{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 97.0, 72.0, 460.0, 412.0 ],
		"bglocked" : 0,
		"defrect" : [ 97.0, 72.0, 460.0, 412.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "vpdelay~ is a more efficient implementation of the vdelay~ design, using pointer arithmetic and other optimizations.",
					"linecount" : 2,
					"patching_rect" : [ 30.0, 345.0, 359.0, 34.0 ],
					"fontname" : "Arial",
					"id" : "obj-19",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 150.0, 180.0, 109.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-7",
					"numinlets" : 3,
					"numoutlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 1 ],
					"hidden" : 0,
					"midpoints" : [ 234.5, 162.0, 204.5, 162.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 2 ],
					"hidden" : 0,
					"midpoints" : [ 339.5, 172.5, 249.5, 172.5 ]
				}
